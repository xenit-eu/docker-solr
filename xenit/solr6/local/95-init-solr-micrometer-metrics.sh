...
if [ "${ALFRED_TELEMETRY_EXPORT_GRAPHITE_ENABLED}" = true ]; then
  if [ none = "${ALFRESCO_SSL}" ]; then
    ...
    # at this point assuming that a valid .pem file is present in ${SOLR_INSTALL_HOME}/keystore
